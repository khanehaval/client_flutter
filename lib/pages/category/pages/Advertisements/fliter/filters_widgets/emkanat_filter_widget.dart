...
class EmkanatFilterWidget extends StatefulWidget {
  ...
  const EmkanatFilterWidget({Key? key, required this.onChange})
      : super(key: key);
    ...
    return Column(
      children: [
        buildSwitchRow(
          "عکس دار",
          shakhsi,
          () => widget.onChange([shakhsi.value ? "عکس دار" : '']),
        ),
        buildSwitchRow("ویدیو دار", amlak,
            () => widget.onChange([amlak.value ? "ویدیو دار" : ''])),
      ],
    );
  }
