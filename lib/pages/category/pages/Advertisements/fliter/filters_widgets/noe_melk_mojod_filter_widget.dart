...
class NoeMelkMojodFilterWidget extends StatelessWidget {
  NoeMelkMojodFilterWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Container(
        height: _show_item_otheremkanatagahi_1.isTrue ? 170 : 50,
