...
void showMizanEjaraMaxBottomSheet(Function(String) onSelected) {
  final TextEditingController _customAmountController = TextEditingController();

  final RxInt index = 0.obs;
  final List<String> options = [
    ' از صد تا یک میلیون تومان',
    ' از یک تا دو میلیون تومان',
    ' از دو تا سه میلیون تومان',
    ' از سه تا چهار میلیون تومان',
    ' از چهار تا پنج میلیون تومان',
    ' از پنچ تا شش میلیون تومان',
    ' از شش تا هفت میلیون تومان',
  ];
