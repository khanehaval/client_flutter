...
class NoesystemGarmayeshFilterWidget extends StatelessWidget {
  ...
  final RxBool _showItemSystemGarm = false.obs;
  final RxString _selectedOption = "انتخاب کنید".obs;
  final RxBool _isChecked = false.obs;
  final RxBool _isDeleted = false.obs;
  final RxString _headerText = "نوع سیستم گرمایش".obs;

  @override
  Widget build(BuildContext context) {
    return Obx(
      () => Container(
        height: _showItemSystemGarm.isTrue ? 130.h : 50,
          ...
          children: [
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    if (!_isChecked.value && !_isDeleted.value) {
                      _showItemSystemGarm.value = !_showItemSystemGarm.value;
                    } else if (_isChecked.value && !_isDeleted.value) {
                      _isDeleted.value = true;
                      _isChecked.value = false;
                      _showItemSystemGarm.value = false;
                ...
                GestureDetector(
                  onTap: () {
                    if (_headerText.value != "نوع سیستم گرمایش") {
                      _showItemSystemGarm.value = true;
                    }
                  },
                  child: Padding(
            ...
            if (_showItemSystemGarm.isTrue)
              Column(
                children: [_buildSystemGarmSelector()],
              ),
          ],
        ),
      ),
  ...
  String _getIconAsset() {
    ...
    } else if (_showItemSystemGarm.value) {
  ...
  /// ویجت انتخاب نوع سیستم گرمایش
  Widget _buildSystemGarmSelector() {
    return Container(
      decoration: BoxDecoration(
  ...
  void _updateHeaderText() {
    if (_selectedOption.value != "انتخاب کنید") {
      ...
      _headerText.value = "نوع سیستم گرمایش";
      _isChecked.value = false;
    }
  }
