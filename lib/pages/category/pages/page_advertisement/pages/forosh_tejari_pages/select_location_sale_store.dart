...
class SelectLocationStore extends StatefulWidget {
  const SelectLocationStore({super.key});

  @override
  State<SelectLocationStore> createState() => _SelectLocationOnMapState();
}

class _SelectLocationOnMapState extends State<SelectLocationStore> {
