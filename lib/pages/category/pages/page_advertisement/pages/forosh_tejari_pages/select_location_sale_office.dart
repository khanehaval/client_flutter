...
class SelectLocationOffice extends StatefulWidget {
  const SelectLocationOffice({super.key});

  @override
  State<SelectLocationOffice> createState() => _SelectLocationOnMapState();
}

class _SelectLocationOnMapState extends State<SelectLocationOffice> {
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                alignment: Alignment.centerRight,
                child: SwitchItem(
                    type: type, items: const ["مطب", "ملک اداری"]),
              ),
              const SizedBox(
                height: 30,
              ),
