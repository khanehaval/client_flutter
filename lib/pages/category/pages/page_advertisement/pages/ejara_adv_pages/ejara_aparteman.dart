...
class SelectLocationOnEjaraAparteman extends StatefulWidget {
  const SelectLocationOnEjaraAparteman({super.key});

  @override
  State<SelectLocationOnEjaraAparteman> createState() =>
      _SelectLocationOnMapState();
}

class _SelectLocationOnMapState extends State<SelectLocationOnEjaraAparteman> {
