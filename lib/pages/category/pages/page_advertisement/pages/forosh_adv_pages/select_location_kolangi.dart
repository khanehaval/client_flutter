...
class SelectLocationKolangi extends StatefulWidget {
  const SelectLocationKolangi({super.key});

  @override
  State<SelectLocationKolangi> createState() => _SelectLocationOnMapState();
}

class _SelectLocationOnMapState extends State<SelectLocationKolangi> {
