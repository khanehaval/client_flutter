...
class RealEstate extends StatefulWidget {
  ...
  RealEstate({super.key, required this.onSelect, this.lastLocation});

  @override
  State<RealEstate> createState() => _SelectLocationMapState();
}

class _SelectLocationMapState extends State<RealEstate> {
