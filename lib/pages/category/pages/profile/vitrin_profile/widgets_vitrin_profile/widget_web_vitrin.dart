...
class WidgetWebVitrin extends StatefulWidget {
  @override
  _WidgetWebVitrinState createState() => _WidgetWebVitrinState();
}

class _WidgetWebVitrinState extends State<WidgetWebVitrin> {
  ...
  final RxString _aboutMeText =
      'لینک وبسایت'.obs; // متن نمایش داده شده در جای "درباره من"
            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SvgPicture.asset('assets/images/web_icon_vitrin.svg'),
                ),
              ],
            ),
