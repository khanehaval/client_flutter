...
class WidgetSpecialAd extends StatefulWidget {
  @override
  _WidgetSpecialAdState createState() => _WidgetSpecialAdState();
}

class _WidgetSpecialAdState extends State<WidgetSpecialAd> {
  ...
  final RxString _aboutMeText =
      'آگهی ویژه'.obs; // متن نمایش داده شده در جای "درباره من"
            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SvgPicture.asset('assets/images/archive-book.svg'),
                ),
              ],
            ),
