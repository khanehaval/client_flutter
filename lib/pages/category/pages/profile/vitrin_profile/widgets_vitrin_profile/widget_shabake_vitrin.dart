...
class WidgetShabakeVitrin extends StatefulWidget {
  @override
  _WidgetShabakeVitrinState createState() => _WidgetShabakeVitrinState();
}

class _WidgetShabakeVitrinState extends State<WidgetShabakeVitrin> {
  ...
  final RxString _aboutMeText =
      'لینک شبکه اجتماعی'.obs; // متن نمایش داده شده در جای "درباره من"
            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SvgPicture.asset('assets/images/instagram_vitrin.svg'),
                ),
              ],
            ),
