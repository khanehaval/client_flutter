...
class WidgetPhotoProfileVitrin extends StatefulWidget {
  @override
  _WidgetPhotoProfileVitrinState createState() =>
      _WidgetPhotoProfileVitrinState();
}

class _WidgetPhotoProfileVitrinState extends State<WidgetPhotoProfileVitrin> {
  ...
  final RxString _aboutMeText =
      'تصویر پروفایل'.obs; // متن نمایش داده شده در جای "درباره من"
