          ...
          child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildItem(
                      'assets/images/Frame_moble.png',
                      1,
                    ),
                    _buildItem('assets/images/Frame_telewsion.png', 2),
                  ],
                ),
                const SizedBox(
                  height: 10,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildItem('assets/images/Frame_digital.png', 3),
                    _buildItem('assets/images/Frame_system.png', 4),
                  ],
                ),
                const SizedBox(
                  height: 10,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildItem('assets/images/Frame_seshovar.png', 5),
                    _buildItem('assets/images/Frame_otodasti.png', 6),
                  ],
                ),
                const SizedBox(
                  height: 10,
