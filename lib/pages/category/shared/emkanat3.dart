          ...
          child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildItem(
                      'assets/images/Frame_yakhchal.png',
                      1,
                    ),
                    _buildItem('assets/images/Frame_ketri.png', 2),
                  ],
                ),
                const SizedBox(
                  height: 10,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildItem('assets/images/Frame_ojagh.png', 3),
                    _buildItem('assets/images/Frame_lebas.png', 4),
                  ],
                ),
                const SizedBox(
                  height: 10,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildItem('assets/images/Frame_tea.png', 5),
                    _buildItem('assets/images/Frame_macro.png', 6),
                  ],
                ),
                const SizedBox(
                  height: 10,
