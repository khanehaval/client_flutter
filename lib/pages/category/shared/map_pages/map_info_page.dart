    ...
    return Column(
      children: [
                      ...
                      onTap: (tapPosition, point) {
                        Get.to(() => SelectLocationMap(
                              ...
                              onSelect: (_) {
                                ...
                                // ذخیره اطلاعات در مدل Location و LngLat
          ...
          children: [
            Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    controller.updateCityId(locationInfo.cityName);
                  },
                  child: Container(
        ...
        Directionality(
          ...
          child: TextField(
            onChanged: (value) {
              // هر بار که متن تغییر می‌کند، این تابع اجرا می‌شود
...
//             onChanged: (value) {
//               // هر بار که متن تغییر می‌کند، این تابع اجرا می‌شود
//               saleApartemanServerModel.description = value;
//             },
//             style: const TextStyle(
//               fontFamily: MAIN_FONT_FAMILY,
//             ),
