                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              _item('assets/images/profile_category.svg',
                                  "میزکار"),
                              const SizedBox(
                                height: 12,
                              ),
                              _item('assets/images/profile_message.svg',
                                  "پیام ها"),
                              const SizedBox(
                                height: 12,
                              ),
                              _item('assets/images/profile_moshavere.svg',
                                  "مشاوران"),
                              const SizedBox(
                                height: 12,
                              ),
                              _item('assets/images/profile_sabt aghahi.svg',
                                  "آگهی های من"),
                              const SizedBox(
                                height: 12,
                              ),
